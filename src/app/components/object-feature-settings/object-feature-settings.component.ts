...
*/
  ...
  private getDefaultLoadSettings(fallback?: boolean): any {
    if (fallback) {
      return {
        preview: this.activeModel.settings.preview,
