...
export class EntitySettingsService {
  ...
  public async loadCameraInititalPosition() {
    ...
    const cameraSettings = Array.isArray(this.entitySettings.cameraPositionInitial)
      ? this.entitySettings.cameraPositionInitial.find(obj => obj.cameraType === 'arcRotateCam')
      : this.entitySettings.cameraPositionInitial;
