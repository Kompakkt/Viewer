...
export const createMarker = (
    scene: Scene, radius: number, ranking: string,
    id: string, transparent: boolean, color?: string,
    ...
    dynamicTexture.drawText(ranking, null, null, font, '#ffffff',
                            color ? color : '#000000', false, true);
