import { IAgent, IAnnotation } from '@kompakkt/common';
...
export const isIIIFAnnotation = (annotation: any): annotation is IIIFAnnotation => {
  return (
    'id' in annotation &&
    'normal' in annotation &&
    'position' in annotation &&
    'value' in annotation
  );
};
...
export const isIIIFData = (data: any): data is IIIFData => {
  return (
    ...
    data.annotations.every(isIIIFAnnotation)
  );
};

export const convertIIIFAnnotation = (
  { id, normal, position, value }: IIIFAnnotation,
  ranking: number,
): IAnnotation => {
    ...
    body: {
      ...
      content: {
        ...
        relatedPerspective: {
          ...
          preview:
            'https://kompakkt.uni-koeln.de:8080/previews/annotation/5e56525cd32cd0237c090355.png',
        },
      },
    },
